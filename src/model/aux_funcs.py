...
from model import network_architectures as arcs

# from profiler import profile, profile_sdn

# from data import CIFAR10, CIFAR100, TinyImagenet, Imagenet10, Imagenet100
...
# def get_dataset(dataset, batch_size=64, add_trigger=False):
#     if dataset == 'cifar10':
...
#         return load_imagenet100(batch_size)
#     elif dataset == 'imagenet10':
#         return load_imagenet10(batch_size)

# def load_imagenet10(batch_size, add_trigger=False):
#     imagenet_data = Imagenet10(seed = get_random_seed(), batch_size=batch_size, add_trigger=add_trigger)
#     return imagenet_data

# def load_imagenet100(batch_size, add_trigger=False):
#     imagenet_data = Imagenet100(seed = get_random_seed(), batch_size=batch_size, add_trigger=add_trigger)
#     return imagenet_data

# def load_cifar10(batch_size, add_trigger=False):
#     cifar10_data = CIFAR10(seed = get_random_seed(), batch_size=batch_size, add_trigger=add_trigger)
#     return cifar10_data
